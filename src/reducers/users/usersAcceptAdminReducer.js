...
export default (state = INITIAL_STATE_BASE, { type, payload }) => {
  const { isLoading, errorMessage, responseMessage } = INITIAL_STATE;

  switch (type) {
    case POST_USERS_ACCEPT_ADMIN_REQUEST:
      return {
        ...state,
        errorMessage,
        responseMessage,
    ...
    case POST_USERS_ACCEPT_ADMIN_SUCCESS:
      return {
        ...state,
        isLoading,
        errorMessage,
    ...
    case POST_USERS_ACCEPT_ADMIN_FAILURE:
      return {
        ...state,
        isLoading,
        responseMessage,
